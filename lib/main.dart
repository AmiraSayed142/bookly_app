...
class BooklyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => NewestBooksCubit(getIt.get<HomeRepoImpl>())..fethedNewestBooks(),
        ),
      ],
 ...
 // -- el  Core Folder hwa el 7agat elly metkrra fe el Features
 // -- el feature bykon feh el tafsel w el proberies of app  
